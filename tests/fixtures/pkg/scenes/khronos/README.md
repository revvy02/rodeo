...
```sh
RODEO_SCENE_REVIEW_DIR=/tmp/rodeo-scenes bun test --timeout 120000 tests/cli/pkg.test.ts -t 'scene:'
blender --background --python tests/utils/validate_scene_blender.py -- /tmp/rodeo-scenes
```
